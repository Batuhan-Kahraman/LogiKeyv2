...
namespace logikeyv2.Controllers
{
    ...
    public class OkulAracTurController : BaseController
    { 
        ...
        public IActionResult Kaydet(IFormCollection form)
        {
            ...
            {
                var allItems = context.OkulAracTur.ToList();
                context.OkulAracTur.RemoveRange(allItems);
                context.SaveChanges();
                ...
                OkulAracTur item = new OkulAracTur();
